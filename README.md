...
* German Credit Dataset analysis using Aequitas /fair_tutorial/0_Aequitas German Dataset.ipynb
* Performing in processing bias migitagation with Gerry Fair Classifier on German Credit Dataset  fair_tutorial/0_in_profess_fair.ipynb
* Performing post processing bias migitagation with calibrated odds-equalizing post-processing algorithm on the German Credit Dataset fair_tutorial/0_postprocessing_fair.ipynb
...
AIF360 is used for loading the German Dataset easily with the API. TODO: add a bit about aequitas
...
### Performing post-processing bias migitagation with calibrated odds-equalizing post-processing algorithm on the German Credit Dataset
...
* Census income classification with LightGBM explain_tutorial/SHAP_Fashion_Mnist_Explainer.ipynb
* Fashion-MNIST SHAP DeepExplainer explain_tutorial/SHAP_Census income classification with LightGBM.ipynb
